...
public class Service_three extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(configuration.smallestScreenWidthDp == 320 || configuration.smallestScreenWidthDp == 400 || configuration.smallestScreenWidthDp == 420 ||
            ...
            setContentView(R.layout.service_three_small);
        }
        else {
        ...
        cont.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Service_three.this, Landing.class));
                Animatoo.animateZoom(Service_three.this);
            }
        });
    }
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 < x2){
                    Intent intent = new Intent(this, Service_two.class);
